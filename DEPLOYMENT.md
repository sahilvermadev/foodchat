# Foodchat: Production Deployment Documentation

This document serves as the permanent technical record and operational runbook for the production deployment of the **Foodchat** (LibreChat fork) full-stack monorepo.
