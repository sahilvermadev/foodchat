...
const useSpeechToText = (
  ...
  } = useSpeechToTextBrowser(onRecordingStart, onTranscript, onTranscriptionComplete);
  ...
  } = useSpeechToTextExternal(onRecordingStart, onTranscript, onTranscriptionComplete);
